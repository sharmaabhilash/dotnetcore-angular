...
export class PhotoEditorComponent implements OnInit {
  ...
  initializeUploader() {
    let url = environment.baseUrl + environment.usersUrl + this.authService.decodeToken.nameid + environment.photoUrl;
  ...
  deletePhoto(photoId: number) {
    this.alertify.confirm("Are you sure you want to delete this photo?", () => {
      let userId = this.authService.decodeToken.nameid;
      this.userService.deletePhotos(userId, photoId).subscribe(
        next => {
